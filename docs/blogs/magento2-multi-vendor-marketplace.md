# User Guide for Adobe Commerce Multi Vendor Extension

Updated 7 May 2026

[Live Demo](https://magento2demo.webkul.in/marketplace/)

[Magento 2 Multi Vendor Extension](https://store.webkul.com/magento2-multi-vendor-marketplace.html) provides a platform where multiple sellers (vendors) can register to marketplace, list, and sell their products or services to customers.

Adobe Commerce Marketplace Extension converts your online store into a complete online marketplace shop.

Therefore, using Magento 2(Adobe Commerce) Marketplace Extension, the seller can manage the inventory, shipment, Seller Profile page, Seller Collection page, and much more.

The seller can add multiple product types like Simple, Configurable, Virtual & Downloadable.

Furthermore, Magento 2 Marketplace Plugin supports all the Magento 2 templates and themes and it is compatible with RWD ([responsive web designs](https://webkul.com/website-development/)).

If you’re looking to make your customers as resellers on your Magento 2 store, then you can check[ Magento 2 Reseller Extension](https://store.webkul.com/magento2-reseller-extension.html)

**Important Notes: **

1. If you’re using Magento version 2.3.0-2.3.3, then please install the Patch file v2.3.0-2.3.3 available in the Magento 2 Marketplace plugin zip.
1. There is no need to install the patch for versions above Magento v2.3.3.
1. The greater version of the Marketplace Extension will not work with the lower version of Magento.
1. If you have Magento 2.0.x then you can use a lower version of the Marketplace.
1. The Multi-Vendor Marketplace version 2.0.1 will not work with the Magento 2.0.x version, it will work with Magento 2.1.x.
1. To manage the Multi-Source Inventory feature at the sellers’ end. You must have installed Marketplace MSI for Magento 2.

Watch below video tutorials to understand Multi Vendor Marketplace Extension workflow:
...
**Note:** Hyva module currently supports only the default vendor dashboard.

### Advance Admin End Features

- Easy configuration of the Marketplace Module.
- Also, magento 2 multi vendor module offers an Attractive design for managing the Products, Sellers, and commissions.
...
- The admin can Inline edit the products in the admin end grid.
- Admin can send global news to sellers.
- Admin can manage the fulfillment label, text and image.
...
- The admin can enable/disable separate dashboard seller wise.
...
- The Admin can do TAX management for the seller’s product.
...
- Magento 2 multi vendor module provides a captcha security feature so that customers can contact sellers. customer can give their reviews.
...
- Sellers can now filter products and orders from general filters provided on top of grid listing.
- Sellers will get low-stock notifications.
- Seller can now add draft products.
- Seller can manage fulfillment label, text and image.

### Other Seller End Key Features
...
Firstly, you need to log in to the [Webkul Store,](https://store.webkul.com/) go to **My Account>My Purchased Products section,** verify, and then download and extract the contents of this zip folder on the system.

### #Upload Folder

When the module zip extracts, follow path src>app and then copy the app folder into the Magento 2 root directory on the server as shown below:

[!\[Magento 2 Marketplace Extension\](https://cdnblog.webkul.com/blog/wp-content/uploads/2016/09/Move-app-folder-2.png)](https://cdnblog.webkul.com/blog/wp-content/uploads/2016/09/Move-app-folder-2.png)
...
Run below mentioned commands to start admin news related messages.

```
php bin/magento queue:consumers:start admin.news.published &
```

Run below mentioned commands to start low stock seller’s products related messages.
...
Furthermore, select the **locale** as German (the language into which admin wants to translate his store content).
...
Now, they have to open the file named **en_US.CSV** for editing.

![translation](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/04/Language1-DP-.webp)

Now, upload it to the path **src/app/code/Webkul/Marketplace /i18n** where the installation of Magento 2 is on the server.

The module translates into the Arabic Language. It supports both RTL and LTR languages.

The user can edit the CSV like the image below.

![language-translation](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/code-1.webp)
...
So, most importantly, If a user wants to translate their module from **English** into the **Arabic** language.

Then they need to follow the path ***app/code/Webkul/Marketplace/i18n*** in their unzipp Magento Marketplace folder.

Forthwith, here the user will get a **CSV** file with the name “**en_US.csv**” as shown below in the snapshot.

![Arabic language translation 1
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/1-3-4-1200x523.webp)

### **Step 2:**

Straightaway just renames this **en_US.csv**  to “**ar_SA.csv**” as shown below in the snapshot.

![Arabic language translation 2
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/2-3-3-1200x529.webp)
...
![arabic languauge](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/code-2.webp)

Even the users can **edit the CSV** as per the below screenshot:

![arabic translation](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/5-1-7.webp)
...
![Multi Vendor- create-account-google-analytics](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/create-account-google-analytics.png)

Now click on the Start for free to create a google analytics account.

![multi vendor - create or signin google account](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/2-12.png)
...
![multi vendor - welcome message](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/3-7.png)

### Additional Details

Now enter the further required details to continue.

![multi vendor - enter the required details](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/4-6.png)

So, after entering the required details click on the Next button.

![multi vendor - google analytics](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/5-6.png)

Now, enter the property name, and select the reporting time zone, and currency.

![6-4](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/6-4.png)
...
![multi vendor select the required data](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/7-3.png)

Now, select from the available options and click on the Create button.

![multi vendor - universal tracking ](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/8-4.png)

### Terms and conditions

Accept the terms & conditions and process further.

![multi vendor - accept terms and conditions](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/9-5.png)

Now select the events for which you want to receive the email notifications from Google and click on the Save button.

![multi vendor - email notification](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/10-4.png)
...
![Configuration settings ](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Config-General-settings-1.webp)

### General Settings – Magento 2 Multi Vendor Extension
...
Additionally, let us say as an example there is a seller S1 and his/her product(P1) price is 100 USD.

So on the sale of product P1 seller will get 80 USD and the admin will get 20 USD as commission if the commission is configured as 20%.
...
![Config- General settings 2](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Config-General-settings-2.webp)

**Fulfillment Settings** –

- Image –  Upload the image by selecting them and will be shown on product page which will be fulfill by admin.
- Label – Write the name and will be used to show in fulfillment label at admin and seller product edit page.
- Text – Write a text and will shown on product page.

Fulfillment settings also manage by the seller in their marketplace edit profile section as shown in below image:

![fulfilllment](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/2vendor-account-settings-edited.webp)

The Fulfillment option is also visible at frontend and specifies the fulfillment of this product as shown in image below:
...
The admin selects this option as “Yes”, as a vendor is also a customer, the vendors are able to have a separate dashboard.

That will not have the account section for the customer however only the vendor dashboard.
...
![Minimum order amount settings
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Minimum-order-amount-settings-1200x493.webp)
...
![Seller dashboard layout settings](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Seller-dashboard-layout-settings.webp)
...
Furthermore, when the option is set to “**No**” which is the default one. In this case, the vendor’s account will have the **vendor **and **customer panel **both.

Both the panel is displayed as per the below image.

#### Vendor Dashboard

![MP daahboard](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-dashboard-1-edited.webp)

![marketplace-vendor-dashboard-reports](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/marketplace-vendor-dashboard-reports-2.webp)

### Separate Seller Panel – Magento 2 Marketplace Extension
...
![vendor dashboard
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/vendor-separate-dashboard-1200x541.webp)
...
![vendor login](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Vendor-separate-login-1200x796.webp)

After **login**, the **vendor dashboard** will appear as shown in the below snapshot.

![vendor separate dashboard](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Vendor-separate-dashboard-1-edited.webp)

![marketplace-vendor-dashboard-activity](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/marketplace-separate-dashboard-reports-901x1024.webp)
...
![vendor account settings - 1
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/1-vendor-account-settings.webp)

![vendor account settings - 2](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/2-vendor-account-settings.webp)

![vendor account - 3](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/3-vendor-account-settings.webp)

![vendor account - 4](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/4-vendor-account-settings.webp)

![vendor account - 5](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/5-vendor-accounts-settings.webp)

### **Vendor Dashboard – Magento 2 Marketplace Extension**
...
![buyer dashboard](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/buyer-dashboard-edited.webp)
...
### **Seller Notifications – Magento 2 Marketplace Extension**
...
![notification](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/vendor-notification-list--1200x500.webp)
...
![list of notification](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/vendor-notification-1200x415.webp)

### Home Icon – Magento 2 Marketplace Extension

After clicking the **home icon** will redirect the vendor to the home page as shown below in the snapshot.

![vendor home icon](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Vendor-separate-dashboard-3-edited.webp)

### Vendor Side – Panel account option
...
Now, the seller can also find the details of the latest orders that have been placed by the customers.

#### **Orders**

Now, clicking the **Orders** menu option will bring up the section to view all the orders that have been placed for this vendor’s products.

Here, the UI components have been used to display the grid that uses Ajax to display the grid data.

![vendor print slip](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/vendor-print-slip.webp)

Clicking the “**Order**” link under the column **View **will allow the seller to view the complete order details.

in short, the seller can then accordingly generate the shipments, invoice,  send emails to customers,cancel the order and print the order details.

![vendor manage order](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/vendor-manage-order-1.webp)

### Products

![vendor add product](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/vendor-add-product.webp)
...
![vendor add product
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/vendor-add-product-simple-edited.webp)

- Here, the seller can easily add their product. After filling the details they need to click on save.
- When the seller click on draft, It adds their products as a draft, it will not visible on frontend. Draft product are those product that are saved but not yet published.

![add draft product at seller end](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/add-draft-product-1.webp)

#### Draft Products

- You can check the draft product list by navigating through Products> Draft products.

![draft product visible](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/draft-product-visible-1.webp)
...
- In the product list, you will get options for manage the products – Enabled products, disabled products, low stock. out of stock, pending products,denied products by admin.
...
![product list](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/MP-product-list.webp)

- Here, when seller click on edit, You can edit your product as shown in image below.
- While editing a product, If the fulfillment checkbox is enabled, then the fulfillment will be done by the admin. If disabled, fulfill by the respective seller as show in image below –

![marketplace fulfillment by seller](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/fulfillment-1.webp)

- Also, In Marketplace Extension, the seller can add filters according to their product status. The seller can choose a status from the available options.
- the seller can also view the pending products and can see the remarks of products which is given by admin as shown in the image below:

![mp-product-list](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-product-list-2-edited.webp)

- The seller can also view the denied products as shown in image below:

![denied-product](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/denied-product.webp)
...
![configuarble product](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Configurable-products-1200x796.webp)
...
![MP Customer](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/MP-Customer.webp)

### **Seller Transactions – Magento 2 Marketplace Extension**
...
![transaction](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Transaction-edited.webp)

Afterward, by clicking the **View** link the vendor can see the **transaction details** as shown below in the snapshot.

![transaction details ](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Tranaction-details-edited.webp)
...
![Earning ](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Earning-890x1024.webp)
...
![earning](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Monthly-earnings-987x1024.webp)
...
![yearly earning](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/yearly-earning.webp)

### **Seller Invoice & Packing Slip PDF Header **

Under this menu option, the seller can add their Invoice and Packing slip Address/Vat/Tax information and this is visible in the header of the pdf files.

![Manage print pdf header info ](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Manage-print-PDF-header-info.webp)

### **Seller Reviews – Magento 2 Marketplace Extension**
...
![mp review](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Marketplace-review.webp)

### Admin News – Magento 2 Marketplace Extension 

Here, The seller will get news for any sale, offer or regarding any updated news.

These News are managed by admin and show to every seller on their dashboard.

![admin news](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Admin-news.webp)

### **Seller Profile Settings – Magento 2 Marketplace Extension**
...
### Product Flag Management: Magento 2 Marketplace Extension
...
![minimum amt setting
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Minimum-amt-setting.webp)

### Minimum amount setting alert to customer 

![minimum amt notify](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/Product-notification-minimum-amt-edited.webp)

### Multi Seller Product checkout by customer 

![product from different seller
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/product-from-diff-store-edited.webp)

### Seller Profile link on order view page 
...
![seller-config-settings
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-flag-config-settings-edited.webp)

As shown in the above image the admin will have to add the following field:

**Enable: Firstly, t**he admin will enable the seller flag feature.

**Text: **This text is displayed to the customer on the seller profile page.

**Guests Can Flag: **Then **, t**he admin will allow the guest users to report a flag against the seller.
...
![Mp-seller flag
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-seller-1200x796.webp)

After that, the list of added reasons gets visible to the admin as shown in the image below:

![seller flag reason](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-flag-reason-list-1200x796.webp)
...
![seller new reason ](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-new-reason-edited.webp)
...
![product-sell-by-store
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/product-sell-by-store-edited.webp)
...
![report-seller
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/report-seller-daskboard.webp)
...
![fill-details-seller
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/fill-details-report-customer.webp)
...
![seller reason
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-flag-reason-edited.webp)

The admin can also take actions against the seller according to the flags. The admin can Deny/ Suspend the seller.

For this, the admin will navigate to **Marketplace Management > Manage Sellers **and click on **deny **as shown in the image below:

![manage seller](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/manage-seller-3.webp)

### Product Flag Management: Magento 2 Marketplace Extension

For managing the **Product Flags** configurations the admin will navigate to **Stores > Configuration > Marketplace >  Product Flags**.

![product-flag-config](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/product-flag-config-edited.webp)
...
![mp-seller flag](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-seller-flag-1200x796.webp)

Admin can click on Product Flag Reason to check the reason list. The list includes the pre-added reasons.

![Product flag reason](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/product-flag-reason-edited.webp)

Click on **New Reason to add one more to the reason bucket. P**rovide the details like **Flag Reason** and **Status** that a new reason will be added to the existing list of product flag reasons.
...
![report product ](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/report-product-frontnend.webp)

After clicking on the Report Product, the customer will provide the report details. Details will be same for registered and guest customers.
...
![report product](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/report-product-sam-edited.webp)
...
![product-flag-reason](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/product-flag-reason-edited-1.webp)
...
![admin remark](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/admin-remark-2.webp)

After that, the admin will have to provide the reason for denying the product. The admin can also check the checkbox to notify the respective seller via email about the denial of the product.

![reason-deny-product](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/reason-deny-product-edited.webp)
...
![seller filter product](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-filter-seller-product.webp)
...
![denied](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/denied-product-looks-1200x508.webp)
...
![MP dashboard](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-seller-flag-1-1200x796.webp)
...
![manae attributes](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/manage-attributes-edited.webp)
...
![seller product](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-products-edited.webp)

### Seller Product Settings – 

![product setting
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-product-settings-956x1024.webp)
...
If this option is selected as “**Yes**“, then the seller on his ** add/edit product** page will find the category tree view for selecting the category for the products as is displayed.

![tree view category](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/tree-category-1.webp)
...
![Dynamic SKU](https://cdnblog.webkul.com/blog/wp-content/uploads/2019/05/Dynamic-SKU.png)
...
![Configuration Settings](https://cdnblog.webkul.com/blog/wp-content/uploads/2019/05/Configuration-Settings.png)
...
![maximum-quantity-5](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/maximum-quantity-5-edited.webp)

### Seller Order’s Settings : Magento 2 Marketplace Extension

![seller order](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-order-settings-1200x796.webp)
...
![order-approval](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/order-approval-edited.webp)
...
![inventory setting
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/inventory-settimgs.webp)

![seller profile page setting
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-profile-page-settimgs.webp)
...
![MP shop ](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-shop-956x1024.webp)
...
![type_1_Seller](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/type_1_Seller.png)

#### **If Admin selects Card Type as Type 2-**

![type2_card](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/type2_card.png)
...
When this option is set “Yes”, then the seller can change the URL to any name they want, and then that new name will appear.

The seller can change the Url of the Profile page, Review page, Collection page & Location page.

![example](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/urlexample.png)
...
![content-pages](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/1-content-pages.webp)

After that admin can create a new page or edit the existing one by selecting edit option under action.

![about us edit page](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/about-us-edit-1.webp)

### Insert Widget

Now, admin has to select ****Edit with page builder >Edit HTML Code> Insert Widget**** under the ** Content **as per the below image:

![about us widget](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/about-us-widget-1.webp)
...
![insert-widgets](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/insert-widgets.png)

***Note:- Herein, an extra Transaction effect option will be visible only in the case of the Magento Enterprise edition. ***

***Otherwise, in the case of the community edition, the field will be the same as above.***
...
**Seller Ids**– Admin has to enter the Ids of the seller which they want to show at the front end and each seller Ids are separate by a comma.

#### **Front-End view**

![multi vendow marketplace](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/About-us_featured_seller-1.png)

### **In the case of Blocks**

The admin has to navigate through **Content > Blocks **as per below image:

![content-block](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/1-content-pages-1.webp)

After that admin can create a new Block or edit the existing one by selecting edit option under action.

![content-block](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/content-block.webp)

Now, Admin has to select **Edit with page builder >Edit HTML Code> Insert Widget **under the ** Content **as per below image:

![content-information](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/content-information-edited.webp)

After clicking on **Insert Widget **the admin can select **Widget Type** as **Vendor Featured** to display the seller profile at the front end.

![insert-widgets](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/insert-widgets-1.png)
...
- The ratio of Height: The admin will select the width.

## Storefront View – Magento 2 Marketplace Extension

![multi vendow marketplace](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Contact-Us_featured_seller.jpg)

### Marketplace Seller Review Settings

![Marketplace Seller Review Settings](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/seller-review-setting.png)
...
![Landing settings - NO](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/landing-settings-no.webp)

![become-seller-no](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/become-seller-no.webp)
...
Marketplace Seller Central Blog at [https://webkul.com/blog/magento2-marketplace-seller-central/](https://webkul.com/blog/magento2-marketplace-seller-central/).

When selected ‘Yes’

![landing-settings-yes](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/landing-settings-yes.webp)

![become seller](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/become-seller-yes.webp)
...
![mp-landing-page-settings-1](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-landing-page-settings-1-956x1024.webp)

![mp-landing-page-settings-2
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-landing-page-settings-2.webp)

![mp-landing-page-settings-3
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-landing-page-settings-3.webp)
...
![example](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/exampleicones.png)
...
![mp-landing-page-ss-11](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-landing-page-ss-1-2-853x1024.webp)

![mp-landing-page-ss-1-2](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-landing-page-ss-1-2-1-853x1024.webp)

**Case 2: When Layout 2 is selected**

**Admin Panel**

![mp-landing-page-layout-2](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-landing-page-layout-2.webp)
...
![mp-landing-page](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-landing-page-ss-2-853x1024.webp)

**Case 3: When Layout3 is selected**

**Admin Panel**

![Layout 3 landing page](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-landing-page-layout-3.webp)

![layout-3-landing page](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/2-layout-956x1024.webp)

![landing-page layout 3](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/3-layout.webp)
...
Admin can set this as “Yes or No” and then anyone can see the Feature icon and Feature label.

Likewise, the admin will select all the Feature icons 1,2,3,4,5, and Feature Label and it will be displayed as per the admin setting.

Admin will explain the overall workflow of the Marketplace through the five icons.

Any Seller can register themselves in the Marketplace, they can customize their profile and add details, then add products for their shops.
...
![mp-landing-page](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-landing-page-ss-3-1-edited.webp)

![mp-landing-page-ss-3-2](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-landing-page-ss-3-2-1200x796.webp)

#### **Seller Layered Navigation: Magento 2 Multi Vendor Extension**
...
![Configuration Settings Stores Magento Admin](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Configuration-Settings-Stores-Magento-Admin.png)

Henceforth, in the frontend the navigation which appears as below-

![seller-filter](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/seller-admin-filter-1.webp)
...
![Seller sitemap settings](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-sitemap-settings.webp)
...
![marketing site map
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/marketing-sitemap-edited.webp)

Here, the admin can add a new Sitemap or edit the existing one.

![list-of-site-map](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/list-of-site-map.webp)
...
To add a new sitemap, the admin can click on **Add Sitemap, **here the admin will have to enter the filename, path.

Select the store view for which the admin wants to generate the sitemap and then click on save.

![add-new-site-map](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/add-new-site-map.webp)

This is how the sitemap can be generated from the admin dashboard for the seller’s profile and seller’s collection page.

![webkul-magento2-multi-vendor-mp-site-map-1](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/webkul-magento2-multi-vendor-mp-site-map-1.png)

### Marketplace Profile Page Fields Hints

Using this field, admin can Enable or Disable the profile hints.

Including shop URL, profile id, Profile Payment Information, Profile Meta Description, Profile Meta Keywords, Shipping & Return Policies and many more.

![webkul_magento2_marketplace_profile_hints](https://cdnblog.webkul.com/blog/wp-content/uploads/2019/05/webkul_magento2_marketplace_profile_hints.png)
...
![mp-profile-page-hint-1](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-profile-page-hint-1-956x1024.webp)

![mp-profile-page-hint-2](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-profile-page-hint-2-956x1024.webp)

![mp-profile-page-hint-3](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-profile-page-hint-3-956x1024.webp)

## Marketplace Transactional Emails – Magento 2 Marketplace Extension

Now, admin can select the custom templates from **Marketing > Communications (Email Template)**.

Created custom templates will be added to the drop-down and admin can use the desired template.

![add-new-template](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/add-new-template-956x1024.webp)

Admin can select the created template like this-

![email-1](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/transaction-email-1-956x1024.webp)

![transaction-email-2](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/transaction-email-2.webp)

### Marketplace Landing Page

The Marketplace Extension is based upon a responsive theme which makes the marketplace landing page more beautiful than before, incorporating an alluring banner with its content.
...
You can see there are four icons that display the overall working of the Marketplace in a list. Any Seller can register themselves in the Marketplace, then add products for their shops.

After adding the products into their shops, selling will be done and then revenue will be generated for the sale.

![mp-landing-page-ss-1](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-landing-page-ss-1-1-853x1024.webp)
...
Or from the store My Account link, and during signup, they need to choose “Want To Become Partner”.
...
![mp vendor login
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/customer-login-901x1024.webp)

The shop URL input field is Ajax driven by which the seller can see whether that particular URL exists or not as below screens. As per the screen, that URL exists.

![vendor-url-shop](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/shop-name-available.webp)
...
![Marketplace seller dashboard](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-seller-dashboard-edited.webp)

The seller can also view the notification count for product approval, new orders placed, and new transactions.

As well as view their transaction list, customer list, review, and order history and draft products.

Here, You can check your draft product and from select option you can edit or delete them.

![draft product](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/draft-product-edited.webp)
...
Using this menu seller will have shop information like shop name, the location of their shop, banner image, shop logo, company locality, shop meta description, and many more parameters.

In the Seller profile panel, the seller can add their various social media links, contact number, Background color.

(if enabled by the admin), Shop title, Company Banner, Company Logo, Tax/Vat number, and Payment details, Policy details, etc.

![MP edit seller profile](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-profile-ss-1-901x1024.webp)

![seller-profile-ss-2](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-profile-ss-2-901x1024.webp)

![seller-profile-ss-3](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-profile-ss-3-901x1024.webp)

#### Edit Seller Shop URL-

One can now edit the different Shop page’s URLs as required for Profile Page, Collection Page, Review page & Location Page,

Then can set it accordingly as shown in the screenshot, which will be displayed in the URL of the particular page requested.

The seller can manage the custom URL for the shop.

![edit-seller-shop-url](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/edit-seller-shop-url-901x1024.webp)
...
![image](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/paymentseller.png)

## Seller Profile View

The admin can set the seller profile view layout by navigating through **Marketplace Management >> Configuration >> Seller Profile Page Settings**

**Case 1**: If the admin selects the Layout 1.
...
![seller_profil_page_Multi Vendor](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/seller_profil_page_.png)

The customer ratings are visible on the seller profile page as shown below in the snapshot.

![seller_review](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/seller_review.png)

#### Seller’s Collection Page

When the user will click on “Products” or “View All Products”, the user will be able to see all the Seller’s Product which can be browsed by categories.

From here buyer can add a product to his cart and proceed to further process.

![john_s_store](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/john_s_store.png)
...
![report product](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/report-product-frontnend-1.webp)

#### Contact Seller

When the buyer clicks on the “Contact Seller” button on the Seller’s product page then the popup for the contact seller will open.

![report product sam](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/report-product-sam-1.webp)

####  Email Template For Product Page Contact Seller

The admin can set the email template for the product page to contact the seller by clicking on **Stores>Configuration>Marketplace Transactional Emails>Ask Question to Seller Regarding Product Template.**

![transaction email](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/transaction-email-1-1-956x1024.webp)

#### Seller’s Feedback Page

Buyers can rate the seller according to his/her opinion under their profile with star rate votes and feedback messages as shown below.

![write-your-review](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/write-your-review.png)

![review](https://cdnblog.webkul.com/blog/wp-content/uploads/2019/05/review.png)

#### Seller’s Location Page

By clicking on the seller location below the Seller’s shop name the buyer will be redirected to the seller’s location(for showing location, please add the company locality of the seller) page.

From the seller’s location, page buyers can view the seller’s location on the map.

![seller_map](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/seller_map.png)

**Case 2**: If the admin selects the Layout 2.
...
![M2MP11](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/M2MP11.png)

### ![M2Mp12](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/M2Mp12.png)

The customer ratings are visible on the seller profile page as shown below in the snapshot.

![m2mp13](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/m2mp13.png)
...
![m2mp14](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/m2mp14.png)

#### Contact Seller

When the buyer clicks on the “Contact Seller” tab on the seller’s profile page, then the popup for the contact seller will open.

![Screenshot-24](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Screenshot-24.png)

#### Email Template For Contact Seller

The admin can set the email template to contact the seller on Seller’s Profile by clicking on **Stores>Configuration>Marketplace Transactional Emails>Ask Question to Seller Template.**

![email-1](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/transaction-email-1-2-956x1024.webp)

#### Seller’s Feedback Page

Buyers can rate the seller according to his/her opinion under their profile with star rate vote and feedback message as shown below.

![mpmp19](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/mpmp19.png)

#### Seller’s Location Page

By clicking on the seller location below the Seller’s shop name the buyer will be redirected to the seller’s location page.

From the seller’s location, page buyer can view the seller’s location on the map.
...
If the admin set only one “Attribute set” and one “Product type” then –

In this case, the seller will be directly taken to the “add product page” without being prompted to select the Attribute Set and the Product Type for the new product.
...
![settings](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-product-settings-11-901x1024.webp)

![Screenshot-1-6](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Screenshot-1-6.png)

#### Case 2 :

If the admin set more than one “Attribute Set” and “Product Type” then – in this case:

The seller will have to first set the Attribute set and the Product type for the new product, and then the seller will be taken to the Add New Product form page.

![product setting
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-product-settings-2.webp)

![Screenshot-2-6](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Screenshot-2-6.png)

#### Case 3 :

If the admin set only one “Attribute Set” and more than one “Product type” then – in this case:

The seller will first have to set the Product Type for the new product, and then the seller will be taken to the Add New Product form page.

![product setting](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-product-settings-3-901x1024.webp)

![Screenshot-from-2020-03-31-13-49-10](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Screenshot-from-2020-03-31-13-49-10.png)

#### **Case 4** :

If the admin sets more than one “Attribute Set” and only one “Product type” then – in this case:

The seller will first have to set the Attribute Set for the new product, and then the seller will be taken to the Add New Product form page as per the below screenshot.

![setting-4](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-prduct-setting03-901x1024.webp)

The seller can add products from the seller’s end. Let us explain all the Product types one by one below.

#### **Si**mple Product

![www.devmage.com_11460_marketplace_product_create_Store-1](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/www.devmage.com_11460_marketplace_product_create_Store-1.png)
...
When the seller click on drafts, It add their product as a draft, It will not visible on frontend. It Will be list in draft products.

Short description, SKU, price, and special price information.

![add draft product](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/add-new-draft-product-2-901x1024.webp)

Stock, availability, visibility, tax class, weight information and URL key.

![Screenshot-1](https://cdnblog.webkul.com/blog/wp-content/uploads/2020/05/Screenshot-1.png)

Meta title, meta keywords, meta description, set allowed product quantity, and product images.

![meta information](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/meta-information.png)

[](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/meta-information.png)

![related product](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/related-product.png)

Downloadable product information, create configurations and select related products.

Select up-sell products.

![upsell products](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/upsell-products.png)

Select cross-sell products.

![cross-sell products](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/cross-sell-products.png)
...
![image-option](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/image-option.webp)

#### Front-end (Product Page):

![details](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/product-details.webp)

The sellers can also add **videos** along with the **product images**.

The admin needs to enter his **YouTube account API Keys **in the admin backend panel by navigating to **Stores**->**Configuration**-> **Catalog**->**Product Video. **

Here, the admin will enter his account(YouTube) API key and then save the configuration.

![product videos](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/product-videos-edited.webp)

![product attributes](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/product-attributes-edited.webp)

Now the sellers will be able to see the “**Add Video**” button on their add product page as shown below in the snapshot.

![add video](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/add-video-button-edited.webp)
...
![add-video](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/add-video.webp)

#### **Downloadable Products**

The seller can add Downloadable Product in Magento 2 Marketplace Extension.

Downloadable Products can be sold into Zip files such as software, e-books, images, music, or video.

![Screenshot-1-7](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Screenshot-1-7.png)

Adding up a downloadable product will create an additional field to enter the URL, as mentioned in the screenshot.

![downloadable product](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/downloadable-product-1200x796.webp)

#### **Virtual Product**

The seller can add Virtual Product which does not have a physical presence.

![Screenshot-21](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Screenshot-21.png)

#### **Configurable Product**

![Screenshot-2-7](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Screenshot-2-7.png)

Before creating a configurable product, the Seller needs to create the attribute for Configurable Products including Attribute Code, Attribute Label, Catalog Input Type, and Values Required.

![multi vendor](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Screenshot-7-5.png)

The seller can add a Configurable product as shown below. You must create an attribute for Configurable product.
...
![create configuration](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/add-video-button-1-edited.webp)

#### **Select Attributes**–

![select-sttributes](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/select-attributes.webp)

Now, the seller will select the attributes value and then click on the Next button.

**Attributes Values**– The seller will select attribute values from the check-box as per the image below.

![attribute-values](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/attribute-values.webp)

Now, the seller will select options for bulk images, pricing, and quantity.

**Upload bulk images-** Here, the seller can select an option like “Apply unique images by attribute to each SKU” and

Then select an attribute from the drop-down and upload image(s) for each attribute values.
...
![bulk images](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/bulk-images-901x1024.webp)

![summary](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/summary-edited.webp)
...
![current-variation](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/current-variation.webp)
...
![Screenshot-6-6](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Screenshot-6-6.png)
...
There is a mass delete option by which sellers can delete a whole product at a time.

![my product list](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/my-product-list-1200x796.webp)

The seller can use the Filter property in which products can be filtered according to Product Name, Status & Date.
...
![transaction-list](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/transaction-list.webp)
...
![mp-seller-dashboard](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-seller-dashboard-1.webp)

### Timely Earnings Report

The seller can view the earning report of the store in terms of the day, month & year wise.

#### Day Wise Report

The seller can view the earning report of the store day-wise.

![Earnings](https://cdnblog.webkul.com/blog/wp-content/uploads/2020/03/Earnings.png)

The seller can select the period as “Day”, and will enter the specific day to day period. A sales vs day wise graph will show you the sales day wise.

In addition, the seller can view the grid view of the total earnings day-wise.

#### Month Wise Report

The seller can view the earnings report of the store Month wise.

![Screenshot-2-5](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Screenshot-2-5.png)
...
![Screenshot-12-3](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/Screenshot-12-3.png)
...
Setting up Multi store Magento 2 is one of the variable functionalities Magento 2 brings to store owners.

This feature allows you to create stores as many as you need only in a single configuration.

All stores that share the same domain and be set up as subdomains of the same domain.

It has entirely different domains, yet possibly shares the same backend for easier administration.

![multi vendow marketplace](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/how-to-setup-multiple-stores-magento-2-choose-new-store-view.png)

#### **Multi-Site **

The website is the top-level container for sites, shipping methods, payment methods, and so on.

If you want to create completely separate sites that do not share the cart, shipping methods, and so on.

It is obligatory to create separate websites that will use the same domain or different domains.

![Store-view](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/store-view-edited.webp)

#### **Multi-currency.**

**Configure Currency Magento 2** to determine what currency customers will allow using when checking out your store.

The currency symbol will appear in product prices and sales documents such as orders and invoices. Most interestingly, store admins are able to customize their appearance if needed.

Moreover, with **Magento 2 configuration**, you can set more than 20 currency units of the corresponding countries in the world.

If your store accepts multiple currencies, Currency Chooser is available in the header of the storefront.

![currency-setup](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/currency-setup.webp)

The customers can choose their preferred currency at the store front-end.

![mp-seller-dashboard](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-seller-dashboard-2.webp)
...
![my-order-history](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/my-order-history.webp)
...
![Download slip](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/download-slip-edited.webp)
...
![order-details](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/order-details.webp)

#### Refund

The seller can also refund the amount to his/her customers from the Magento 2 Marketplace Extension.

After creating the invoice, the seller will click on “Credit Memo” like the image below:

![credit-memo-order](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/credit-memo-order.webp)
...
Also, the seller can track his paid commission, orders and can filter the results using year, month, week and day using an interactive map.

Seller will be able to see his top-selling category list. Similarly, the seller can see his sales statistics

Such as total sales over time,orders over time , average order value over time, as a graph and can filter the results using the year, month, week, and day shown in below image –

![multivendor-marketplace-dashboard](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/marketplace-vendor-dashboard.webp)

Using seller dashboard seller can track his latest order, notifications, price rating, value rating,quality rating, Latest comment and reviews in their Activities section.

![marketplace-vendor-dashboard-reports ](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/marketplace-vendor-dashboard-reports-3.webp)

If Seller has any doubts or query then, they can frequently ask the questions or doubts to the admin by clicking on Ask Question to Admin button.

This is a way of communication between Seller and Admin for Seller’s query.

![ask question to admin](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/ask-question-to-admin-edited.webp)

#### Admin News

The seller can see the news listing published by admin in the “**Admin News**” as shown in below image –
...
For example, if an order is placed with three products (A, B, C) of Seller (x,y,z) respectively.

So when order invoice will be created then sellers (X, Y, Z) will receive an email for their products (A, B, C respectively) with order details.
...
The admin can also view the notification count for new seller requests, add or edit seller product and new feedback.

The admin can also view the notification count for new seller requests, add or edit seller product and new feedback.

![Admin dashboard](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/mp-seller-flag-2-1200x796.webp)

Please refer from the screenshot below:

### Manage Products

This menu is responsible for managing Seller’s Product from Marketplace configuration panel (**Store > Settings > Configuration**).

Product approval is required then, in this case, every product added by seller needs to be approved by admin.

Product approval will happen from the Manage Product menu as per the screenshot. There is also a Deny and remark option by which admin can deny and remark the Seller’s product for a valid reason.

![admin-remark](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/admin-remark.webp)
...
![deatls page](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/go-to-details-page.webp)

The admin can give remark to any pending product by clicking on the Remark button as shown in image below –

![remark to product](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/remark-to-product-1200x455.webp)

The admin can deny any approved product by clicking on the Deny button for a particular reason.

![deny product](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/deny-the-product-edited.webp)
...
1. Approve- Admin can approve the seller.
1. Processing- Admin can set the status of the seller profile from pending to processing.

![manage seller](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/manage-seller-2-1200x520.webp)
...
![manage-seller-order
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/manage-seller-order.webp)

In the Magento 2 Marketplace Extension, the admin can deny any seller by clicking on the Deny Button and entering the reason.

To clear out the message admin can click the reset button.

![deny-seller](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/deny-seller-edited-1.webp)
...
![M2MP1](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/M2MP1.png)

Admin can see Payment details entered by a Seller during account creation. These payment details will be used by the admin to pay the sellers.

![M2MP2](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/M2MP2.png)
...
![M2MP3](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/M2MP3.png)

The admin can assign categories to a seller by going to the Assign Category option as visible in the screenshot below. The seller can now add products and select only the assigned categories.

![M2MP4](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/M2MP4.png)
...
Here the admin finds a complete list of products in the catalog.

Admin checks the Ids of the products that are to be assigned to the seller and click the save customer button after that to assign the products to the seller.

![M2Mp5](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/M2Mp5.png)

The admin can assign attribute set to the vendor as per the below image.

![M2mp7](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/M2mp7.png)

Using this field admin can remove any seller from the Marketplace and make him a normal customer.

![M2Mp6](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/M2Mp6.png)

#### **Assign Seller to the Product**

Just like the admin assigns product to the seller, in Magento 2 Marketplace Extension, the admin also assign sellers to products.

For this, the admin opens the product in edit mode and then select the seller to assign the product:

![webkul_magento2_multi_vendor_mp_admin_assigns_seller_to_product](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/webkul_magento2_multi_vendor_mp_admin_assigns_seller_to_product.jpg)

**Note: **This functionality does not work for the products which are already assigned to their respective sellers.
...
Here the admin can see the seller’s name in the product list.

**Note:**  If products are already created by the admin or sellers then execute given command to assign seller or admin id on products.

```
php bin/magento assign:mp:product
```

![admin manage seller product](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/admin-remark-3.webp)

## Manage Commission

Here in the Magento 2 Marketplace Extension, admin can view details like Seller ID, Commission percentage, Total Sales, Received Amount, Remaining Amount, Commission value and Last paid.

![manage-commission
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/manage-commision-edited.webp)

#### Seller Transaction

Here, the admin can view the transaction detail which comes after the admin pays the seller.

![seller-transaction
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-transcation-edited.webp)

#### Manage Feedback

This menu is responsible for all the reviews. Admin can approve, unapproved, and delete the reviews. Unapproved or deleted.

Reviews will not appear in Seller’s account. Admin can also see the ratings for price, value, and quality in terms of the star.
...
![admin-publish-news](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/admin-publish-news.webp)

Here, the admin can also add the news by clicking on **“New News”** and It will be visible to all sellers in their admin news section.
...
Under **Stores>Configuration>Marketplace >Seller profile Page Settings** as shown below, many pages are affected by this setting.

![display-seller-profile](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/seller-setting-no-edited.webp)

#### Landing Page – Magento 2 Marketplace Extension

Seller information is hidden from the marketplace landing page as shown below.

![No product visible](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/no-product0visible-901x1024.webp)

On the product page, the seller information which is visible to the customers is hidden as shown below in the screenshot.

#### Product Page

![product-details](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/product-details-1-edited.webp)

#### Seller Order History Page

On ** My Order History page**, the buyer information hides from the seller as shown below.

![order-history](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/my-order-history.webp)

The buyer information also hides at the **View Order Details** page as shown below in the screenshot.

![order-details](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/view-order-details-1200x796.webp)

Now, you can see the buyer details are hidden for the **Shipment Tab** as shown below in the screenshot.

![new-shipment](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/new-shipment-901x1024.webp)

Furthermore, the **Packaging Slip** downloaded as a PDF does not have any buyer details on it as shown below in the screenshot.

![packing-shipment-slip](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/packing-slip-shipment.webp)

### Invoice and Credit Memo

#### **Invoice** 

Now, the buyer information will hide on the **View Invoice Details **page of the seller as shown below.

![Invoice details ](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/invoice-details-1.webp)

![invoice-information](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/invoice-ss-2.webp)

#### **Credit Memo** 

However, buyer information is hidden at the **Credit Memo Generation** page .

Additionally, on the **View Credit Memo** details page, the buyer information is hidden as per the below screenshot.

![new-credit-memo](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/new-credit-memo-1.webp)

![credit-memo-marketpalce](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/new-credit-memo-2.webp)
...
And Advanced pricing data is synchronized with product pages. For example, if you update a tier price quantity, the system updates the value on the product page.

- On the admin end, the advance pricing can be set on the product. For this,
...
![advance-pricing](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/05/advance-pricing-edited.webp)

## How To Make Tier Price Visible On Seller End?

Certainly, the Tier Price is a major component of Advance Pricing which gives the customer the advantage of receiving a discount on the basis of the quantity purchased.
...
![tier-price-frontend
](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/tier-price-frontend-image-1.webp)

**Extended Functionality-** The Magento 2 Marketplace Extension is having an additional feature.

That enables the seller to have a facility to set tier price for the product for a specific group of people too.

Moreover, this achieves by[ Magento 2 Custom Attribute Marketplace Add-on](https://store.webkul.com/Magento2-Marketplace-Custom-Attribute.html), we can simply go to **Custom Attributes **in the admin panel.

Also, the admin can select the ‘tier_price’ attribute and under the **Action** drop-down, click on ‘**Show In Front**.

![tier price ](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/06/tier-price-image-1-1-1200x528.webp)

Now, the attribute **Tier Price** could be seen on seller front when we open the product in edit mode.

![add-advance-pricing](https://cdnblog.webkul.com/blog/wp-content/uploads/2015/12/add-advance-pricing.webp)
...
For any queries or doubts, you can reach out to us by dropping an email at [\[email protected\]](/cdn-cgi/l/email-protection) or raising a query at our [HelpDesk](https://webkul.uvdesk.com/en/customer/create-ticket/) system.

For more such kinds of extensions, you can view our [Magento 2 Extensions](https://store.webkul.com/Magento-2.html).

Current Product Version - 5.0.2

Supported Framework Version - Magento 2.0.x, 2.1.x, 2.2.x,2.3.x, 2.4.x

![author-thumb](https://cdnblog.webkul.com/blog/wp-content/uploads/2024/08/nishad-2.webp)

[Nishad Bhan 7 Badges](https://webkul.com/blog/author/nishad-bhan981/)

Nishad Bhan excels in analyzing eCommerce processes on the Magento platform, optimizing workflows, and delivering strategic solutions. Expertise ensures seamless platform integration, driving digital innovation and aligning technology with business objectives for growth.

- 7 May, 2026 Updated by - Udayveer Singh
- 26 Feb, 2026 Updated by - Udayveer Singh
